...
export const showTooltipElement = ({ element, tooltip }: { element: any, tooltip: { message: string, position?: "top" | "bottom" | "left" | "right", textStyle?: CSSProperties } }) => {
    ...
    switch (pos) {
        case "top":
            return <div ref={r => {
                ...
                <Text className={`body-3 ${styles['tooltip-message']}`} maxLine={2} style={tooltip.textStyle}>{tooltip.message}</Text>
