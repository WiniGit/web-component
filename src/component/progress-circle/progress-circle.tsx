...
export function ProgressCircle(props: {
    ...
    return <svg id={props.id} className={props.className} width="100%" height="100%" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ ...(props.style ?? {}), width: props.size ?? '4.8rem', height: props.size ?? '4.8rem' }} >
