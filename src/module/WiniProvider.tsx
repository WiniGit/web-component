...
export const initializeProject = async (winiDomain: string, props: { pid?: string, domain?: string }) => {
    ...
    tmp.innerHTML = `
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/WiniGit/web-component@e3c9046/src/skin/root.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/WiniGit/web-component@e3c9046/src/skin/layout.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/WiniGit/web-component@e3c9046/src/skin/typography.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/WiniGit/web-component@e3c9046/src/skin/toast-noti.min.css">
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/WiniGit/web-component@e3c9046/src/skin/style.css">
    `
